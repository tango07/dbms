<?php include('troopdel.php'); ?>

<!DOCTYPE html>
<html>
<head>
	<title>Troops remove or see</title>
      ...
      <div class="card-body">
        <form method="post" action="">
          <div class="input-group form-group">
            ...
            <input type="text" class="form-control" placeholder="Troop Id" name="troop_id" required>
          </div>
