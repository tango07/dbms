<?php include('retireddel.php'); ?>

<!DOCTYPE html>
<html>
<head>
	<title>Retired Personnel</title>
      ...
      <div class="card-body">
        <form method="post" action="">
          <div class="input-group form-group">
            ...
            <input type="text" class="form-control" placeholder="Personnel Id" name="id" required>
          </div>
