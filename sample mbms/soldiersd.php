<?php include('soldierdel.php'); ?>

<!DOCTYPE html>
<html>
<head>
	<title>Soldiers remove or see</title>
      ...
      <div class="card-body">
        <form method="post" action="">
          <div class="input-group form-group">
            ...
            <input type="text" class="form-control" placeholder="Soldier Id" name="Id" required>
          </div>
