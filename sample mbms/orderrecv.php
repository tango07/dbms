      ...
      <div class="card-body">
        <form method="post" action="">
          ...
          <div class="input-group form-group">
            ...
            <input type="text" class="form-control" placeholder="Seller" name="seller" required>
          </div>
          <div class="input-group form-group">
            <div class="input-group-prepend">
              <span class="input-group-text"><i class="fas fa-balance-scale"></i></span>
            </div>
            <input type="date" class="form-control" placeholder="Received on" name="rec_on" required>
          </div>
          <div class="input-group form-group">
            <div class="input-group-prepend">
              <span class="input-group-text"><i class="fas fa-balance-scale"></i></span>
          ...
          <div class="form-group">
            <input type="submit" value="Add"  name="add_ord" class="btn float-right login_btn">
          </div>
        </form>
        <form action="military_base.php">
          ...
          <a style="color: #FFC312;" href="http://localhost/sample%20mbms/ordrsd.php">Click To See or Remove records</a>
      </div>
